	var ALLTOOLDATA = {
		lifeTool: {
			query: {				
                 "huoche":{
					href:"http://tj.tieyou.com/gw.php",
                ...
                "hangban":{
                href:"http://e.ctrip.com/flight/eflightonline/searchflights.aspx",
		...
		bg:"images/life/quhaochaxun.png",
			...
			pay: {
                ...
                "youxichongzhi":{
                href:"http://s8.taobao.com/search?pid=mm_10149879_746203_13070437&mode=63&refpos=&cat=99&commend=all&s=0&sort=commend&n=40&olu=yes&yp4p_page=0&viewIndex=1",
                title:"游戏充值",
                type:"text",
				status:''
                },
				...
				status:''
                 ...
                 "jiaobaoxian":{
                href:"http://s.click.taobao.com/t_9?p=mm_10149879_746203_13070437&l=http://baoxian.taobao.com/",
                title:"买保险",
                type:"text",
				status:''
                },
                 "zhuce":{
                href:"http://www.1hai.cn/index.aspx",
                title:"租车",
                type:"text",
				status:''
                }
			...
			ticket: {
                "youapiaowu":{
                href:"http://s.click.taobao.com/t_9?p=mm_10149879_746203_13070437&l=http://trip.taobao.com/menpiao/index.htm",
                title:"景点门票",
                type:"text",
				status:''
                },
                "maicaipiao":{
                href:"http://union.500.com/pages/interfacehezuo.php?coopid=1605&adid=97",
                title:"买彩票",
                type:"text",
				status:''
                },
                ...
                "dianyingpiao":{
                href:"http://s.click.taobao.com/t_9?p=mm_10149879_746203_13070437&l=http://dianying.taobao.com/",
                title:"电影票",
                type:"text",
				status:''
                },
                "jipiao":{
                href:"http://www.etpass.com/",
                title:"买机票",
                type:"text",
				status:''
                },
                "hotel":{
                href:"http://www.elong.com/",
                title:"订酒店",
                type:"text",
				status:''
                }
			...
			info: {
                ...
                "caipiao":{
                href:"http://www.9188.com/user/from.go?comeFrom=765h&backurl=http://www.9188.com/kaijiang/",
                ...
                "dianshiyugao":{
                href:"http://0873gou.gouwuke.com/tuangou/index.do?e=",
                ...
                "caipu":{
                href:"http://0873gou.gouwuke.com/gouhuasuan.html?e=hao9",
		...
		interTool: {
			...
			planet: {
                ...
                "xingzuoyunshi":{
                href:"http://xingzuo.1518.com/astro4.html",
			  ...
			  "yuanfen":{
                ...
                "renpinjisuanqi":{
                href:"http://app.baidu.com/app/enter?appid=136048",
                title:"藏头诗",
                type:"text",
					status:''
                },
				...
				"xingmingpeidui":{
				   href:"http://www.go108.com.cn/unit007/item00048/index.php",
				   title:"姓名配对",
				   type:"text",
				   status:''
				   },
			  ...
			  "taluopai":{
				  href:"http://astro.lady.qq.com/tarot/tarot.shtml",
				  title:"塔罗牌在线占卜",
				  type:"text",
				  status:''
				  }, 
			  "taijishenshu":{
				  href:"http://www.81baobao.com/",
				  title:"手机铃声下载",
				  type:"text",
				  status:''
				  }
			...
			shop: {
				...
				"pinganchexian":{
					href:"http://chexian.sinosig.com/simplePremium/chexian_emar.jsp",
					title:"阳光车险计算器",
					type:"text",
					status:''
					},
		...
		softTool: {
			...
			video: {
                ...
                '风行': {
	 			href:'http://j.union.ijinshan.com/jump.php?u_key=104050',
                ...
                'uusee': {
	 			href:'http://j.union.ijinshan.com/jump.php?u_key=20626',
     			bg: 'images/life/uusee.jpg',
     			title: 'uusee',
	 			type: 'download'		
				},
                '皮皮': {
	 			href:'http://zl.mylead.cn/cpaDirectUrl.aspx?d=14532&sn=purIY2b%2bQB8k3fYAJKlxiCzD8Qw%2fqvyi',
	 ...
	 type: 'download'		
                    ...
                    '猎豹浏览器': {
	 href:'http://j.union.ijinshan.com/jump.php?u_key=79256',
	 ...
	 type: 'download'		
			...
			system: {
                   '金山卫士': {
	 href:'http://j.union.ijinshan.com/jump.php?u_key=79243',
	 ...
	 type: 'download'		
			...
			antiVirus: {
                    '金山毒霸': {
	 href:'http://j.union.ijinshan.com/jump.php?u_key=552',
	 ...
	 type: 'download'		
			...
			game: {
            '4399游戏盒': {
	 href:'http://www.3399.com/?fr=10009-1',
     bg: 'images/life/4399youxihe.jpg',
     title: '3399游戏盒',
	 type: 'download'		
					},
                    '植物大战僵尸': {
	 href:'http://www.3399.com/games/14619.html?fr=10009-1',
	 ...
	 type: 'download'		
                    ...
                    '连连看': {
	 href:'http://www.3399.com/xyx/xiuxian6-58-0-0-0-1-1-1.html?fr=10009-1',
     bg: 'images/life/lianliankan16.jpg',
     title: '连连看',
	 type: 'download'		
					},
                     '祖玛': {
	 href:'http://www.3399.com/xyx/xiuxian6-64-0-0-0-1-1-1.html?fr=10009-1',
