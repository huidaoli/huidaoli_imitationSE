...
(function(){
        ...
        document.writeln('<link href="http://www.2345.com/neiye/standard/css/skin_'+cook+'.css" rel="stylesheet" type="text/css"  charset="gb2312" />');
        document.writeln('<base target="_blank">');
})();

document.onready=function(){if(ready_){return};ready_=true;storeUtil.init();};
function bindReady(){
