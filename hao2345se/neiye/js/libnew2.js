...
var cookieExpires = 3600 * 24 * 180;//cookieÉú´æÊ±¼ä
...
function s_cookie(){
	var _arg=[],_para={};
	//alert(typeof(_arg[0]).toLowerCase());
	for(var _i=0,_len=arguments.length;_i<_len;_i++){
		_arg[_i] = arguments[_i];
	}
	if(String.prototype.toLowerCase.apply(typeof(_arg[0]))!="string"){
		switch(_arg[0].store){
			case "ie":
	...
	_para.exps=typeof(_arg[2])!="undefined"?Math.ceil(_arg[2]/(3600*24)):undefined;
	_para.name=_arg[0];
	_para.val=_arg[1];
	_para.path=_arg[3];
	_para.domain=_arg[4];
...
(function(){
        var cook = GetCookie('skin');
		if (cook === null)
		{
			cook = 0;
		}
        if (!(/^[0-9]+$/).test(cook) || cook < 1) cook = '1';
        //document.writeln('<link href="/neiye/standard/css/skin_'+cook+'.css" rel="stylesheet" type="text/css"  charset="gb2312" />');
        document.writeln('<base target="_blank">');
})();

/*document.onready=function(){if(ready_){return};ready_=true;storeUtil.init();getcdsvisit();};
function bindReady(){
