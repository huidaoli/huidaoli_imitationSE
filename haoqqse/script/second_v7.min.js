...
passwd:"#{p}",domainname:"21cn.com"}},{mail:"renren",name:"人人网",action:"http://passport.renren.com/PLogin.do",params:{email:"#{u}",password:"#{p}",origURL:"http://www.renren.com/Home.do",domain:"renren.com"}},{mail:"baidu",name:"登录百度",action:"https://passport.baidu.com/?login",params:{u:"http://passport.baidu.com/center",username:"#{u}",password:"#{p}"}},{mail:"51",name:"51.com",action:"http://passport.51.com/login.5p",params:{passport_51_user:"#{u}",passport_51_password:"#{p}",gourl:"http%3A%2F%2Fmy.51.com%2Fwebim%2Findex.php"}},
{name:"@qq.com",jump:!0,action:"http://mail.qq.com"},{name:"@foxmail.com",jump:!0,action:"http://mail.qq.com/cgi-bin/loginpage?t=fox_loginpage"},{name:"@gmail.com",jump:!0,action:"http://gmail.com"},{name:"@hotmail.com",jump:!0,action:"https://login.live.com"}];(function(){if(d&&f&&h&&g&&(f.onsubmit=function(){if(0==d.getSelectIdx())return alert("请选择邮箱"),!1;if(!haveClass(h,"onfocus")||""==h.value.trim())return alert("请输入邮箱用户名"),!1;if(""==g.value.trim())return alert("请输入邮箱密码"),!1;if(l)for(key in l)a:{var a=
...
m=a.form,e=a.sourcePara,u=null,p=a.logo,t=a.engine_list,v=a.on_engine_list_open,n=a.on_engine_list_close,r=a.on_engine_change,q="/images/logo_soso_withname.png",s=a.enable_multi_engin,o=s&&a.engin_index||0,B=0,C=[];C[0]=o;if(g){var x=[[{action:"http://www.sogou.com/sogou",key_name:"query",hiddeninputs:{pid:"sogou-site-220c77af02f8ad85"},logo_img:"/images/logo_soso_sogou.png"},{action:"http://www.baidu.com/s",key_name:"wd",logo_img:"/images/logo_baidu.png"},{action:"http://www.google.com.hk/search",logo_img:"/images/logo_google.png",key_name:"q"}],[{action:"http://image.soso.com/image.cgi",hiddeninputs:{sc:"img"}}],
...
function MobileCharge(){function a(a){var d=a.substring(0,3),f=a.substring(0,4);return a=/^1\d{10}$/.test(a)?0<="130,131,132,155,156,185,186,145".indexOf(d)?"联通":0<="133,153,180,189".indexOf(d)?"电信":"1349"==f?"电信":0<="134,135,136,137,138,139,150,151,152,157,158,159,187,188,147".indexOf(d)?"移动":!1:!1}(function(){var b=new SelectCtl($("currentCharge"),$("chargeSelect"));b&&$("mobileAutoBtn")&&($("mobileAutoBtn").onclick=function(){var d=$("chgmobile");cVal=d.value;eVal=b.getOptions(b.getSelectIdx());
para="phone="+cVal+"&q="+eVal+"&cat=50004958&pid=mm_10054659_163834_9583678&mode=23&commend=1%2C2";""==cVal?(alert("请输入手机号码。"),d.focus()):a(cVal)?"30000"==eVal&&"联通"==a(cVal)?(alert("联通号码暂不支持300元充值！"),b.focus()):window.open("http://s8.taobao.com/search?"+para):(alert("您输入的手机号码不正确，请重新输入！"),d.focus())})})()}
...
function TopBar(a){a||(a={});var b=a.container||$("topWrap");b.appendChild(function(){var a=document.createElement("div");addClass(a,"fl");for(var b=[{text:"实用查询",href:"/chaxun.html"},{text:"电影",href:"http://v.6164.com/"},{text:"电视剧",href:"http://v.6164.com/tv/"},{text:"团购",href:"http://tuan.6164.com/"},{text:"游戏",href:"/youxi.html"},{text:"彩票",href:"/caipiao.html"}],h=["<a class='setIndex' href='javascript:;' target='_self'><span class='icon'></span><span>设为主页</span></a><span class='line'></span>"],
...
a){for(;a&&a!=b&&a!=document.body;)a=a.parentNode;d=a==b}d||g&&g.hidden()});addListener(b,"click",function(){g&&g.hidden()})}a.href&&(b.href=a.href);return b}function g(a){var b=100;a.style.zoom=1;var d=setInterval(function(){b-=5;a.style.opacity=parseFloat(b/100);a.style.filter=" alpha(opacity = "+b+");";0>=b&&(clearTimeout(d),addClass(a,"nodisplay"))},15)}function j(){var a=document.createElement("a");a.innerHTML="退出";a.href="#";addListener(a,"click",function(a){stopBubble(a);l.notify("click_exit")});
return a}var l=new Observable,m=null,e=null,u=99,p={qzone:{className:"qZone",has_tip:!0,dom:null,href:"http://qzone.qq.com",menu_config:{title:"QQ空间",items:[{html:function(){return!e||!e.qzone||!(e.qzone.initnum+e.qzone.passivenum)?"":"好友动态("+b(e.qzone.initnum+e.qzone.passivenum)+")"}},{html:function(){return!e||!e.qzone||!e.qzone.aboutnum?"":"与我有关("+b(e.qzone.aboutnum)+")"}}]}},weibo:{dom:null,menu:null,has_tip:!0,href:"http://t.qq.com",className:"twitter",menu_config:{title:"腾讯微博",items:[{html:function(){return!e||
!e.weibo||!e.weibo.home?"":"未读消息("+b(e.weibo.home)+")"}},{html:function(){return!e||!e.weibo||!e.weibo["private"]?"":"未读私信("+b(e.weibo["private"])+")"}},{html:function(){return!e||!e.weibo||!e.weibo.fans?"":"新增听众("+b(e.weibo.fans)+")"}},{html:function(){return!e||!e.weibo||!e.weibo.mentions?"":"提到我的("+b(e.weibo.mentions)+")"}},{html:function(){return!e||!e.weibo||!e.weibo.create?"":"首页广播("+b(e.weibo.create)+")"}}]}},qqmail:{dom:null,className:"mail",hasseperate:!0,has_tip:!0,href:"http://mail.qq.com",
menu_config:{title:"QQ邮箱",items:[{html:function(){return!e||!e.qqmail||!e.qqmail.unreadcount?"":"未读邮件("+b(e.qqmail.unreadcount)+")"}}]}},golds:{className:"gold",href:"http://soso.qq.com/q?bid=303&cid=dh.my.coin&ch=dh.my.coin&channel=naved",hasseperate:!0}},t={},v=a.nologintip||!1;this.createLoginView=function(a){if(!m){m=document.createElement("div");t=f(a.getFaceImgUrl(),a.getNick());m.appendChild(t);m.appendChild(d());for(k in p)p[k].dom=h(p[k]),p[k].dom&&m.appendChild(p[k].dom),function(a,b){addListener(b.dom,
